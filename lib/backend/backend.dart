...
import 'schema/chatbox_record.dart';
...
export 'schema/chatbox_record.dart';
...
/// Functions to query ChatboxRecords (as a Stream and as a Future).
Future<int> queryChatboxRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ChatboxRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ChatboxRecord>> queryChatboxRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<ChatboxRecord>> queryChatboxRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<ChatboxRecord>> queryChatboxRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
