...
class AppStateNotifier extends ChangeNotifier {
  AAYSAnalyticsFirebaseUser? initialUser;
  AAYSAnalyticsFirebaseUser? user;
  ...
  void update(AAYSAnalyticsFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => TaskDetailsWidget(
                toDoNote: params.getParam('toDoNote',
                    ParamType.DocumentReference, false, ['ToDoList']),
              ),
            ),
            FFRoute(
              name: 'MyProfile',
            ...
            FFRoute(
              name: 'ChatBasic',
              path: 'chatBasic',
              builder: (context, params) => ChatBasicWidget(
